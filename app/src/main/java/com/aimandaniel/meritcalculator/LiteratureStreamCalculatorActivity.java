...
public class LiteratureStreamCalculatorActivity extends AppCompatActivity {

    private Spinner bm_spinner;
    private Spinner maths_spinner;
    private Spinner hist_spinner;
    private Spinner sc_spinner;
    private Spinner pi_spinner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_literature_stream_calculator);
        ...
        this.bm_spinner = findViewById(R.id.bm_spinner);
        this.sc_spinner = findViewById(R.id.sc_spinner);
        this.hist_spinner = findViewById(R.id.hist_spinner);
        this.pi_spinner = findViewById(R.id.pi_spinner);
        ...
        this.bm_spinner.setAdapter(adapter);
        this.sc_spinner.setAdapter(adapter);
        this.hist_spinner.setAdapter(adapter);
        this.pi_spinner.setAdapter(adapter);
    ...
    public void lit_calculate_button_clicked(View v)
    {
        Resources res = getResources();
        int[] grade_points = res.getIntArray(R.array.grade_points);

        int bm_position = this.bm_spinner.getSelectedItemPosition();
        int bm_point = grade_points[bm_position];

        int maths_position = this.maths_spinner.getSelectedItemPosition();
        int maths_point = grade_points[maths_position];

        int hist_position = this.hist_spinner.getSelectedItemPosition();
        int hist_point = grade_points[hist_position];

        int sc_position = this.sc_spinner.getSelectedItemPosition();
        int sc_point = grade_points[sc_position];

        int pi_position = this.pi_spinner.getSelectedItemPosition();
        int pi_point = grade_points[pi_position];
        ...
        int main_subjects_point_sum = bm_point + maths_point + sc_point + hist_point + pi_point;
    ...
    public void lit_help_button_clicked(View v)
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        LayoutInflater inflater = getLayoutInflater();
        View view = inflater.inflate(R.layout.lit_stream_help_dialog, null);
